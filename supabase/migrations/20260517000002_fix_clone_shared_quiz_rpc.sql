-- Migration: Fix clone_shared_quiz RPC to prevent self-cloning
...
BEGIN
    ...
    -- Check if the creator is opening their own shared quiz
    IF v_original_quiz.user_id = v_user_id THEN
        RETURN json_build_object(
            'new_quiz_id', p_original_quiz_id,
